...
export interface MintBasicNftInterface extends Interface {
  getFunction(
...
export interface MintBasicNft extends BaseContract {
  connect(runner?: ContractRunner | null): MintBasicNft
  waitForDeployment(): Promise<this>

  interface: MintBasicNftInterface
