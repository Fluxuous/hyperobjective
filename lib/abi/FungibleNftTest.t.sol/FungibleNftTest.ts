...
export interface FungibleNftTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'IS_TEST'
      | 'PUG_URI'
  ...
  decodeFunctionResult(functionFragment: 'fungibleNft', data: BytesLike): Result
...
export interface FungibleNftTest extends BaseContract {
  connect(runner?: ContractRunner | null): FungibleNftTest
  waitForDeployment(): Promise<this>

  interface: FungibleNftTestInterface
  ...
  fungibleNft: TypedContractMethod<[], [string], 'view'>
