...
export interface FungibleERC404Interface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DOMAIN_SEPARATOR'
      | 'ID_ENCODING_PREFIX'
...
export interface FungibleERC404 extends BaseContract {
  connect(runner?: ContractRunner | null): FungibleERC404
  waitForDeployment(): Promise<this>

  interface: FungibleERC404Interface
