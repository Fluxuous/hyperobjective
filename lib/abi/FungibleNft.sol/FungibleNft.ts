...
export interface FungibleNftInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'DOMAIN_SEPARATOR'
      | 'ID_ENCODING_PREFIX'
...
export interface FungibleNft extends BaseContract {
  connect(runner?: ContractRunner | null): FungibleNft
  waitForDeployment(): Promise<this>

  interface: FungibleNftInterface
