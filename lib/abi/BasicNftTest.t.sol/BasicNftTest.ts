...
export interface BasicNftTestInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'IS_TEST'
      | 'PUG_URI'
...
export interface BasicNftTest extends BaseContract {
  connect(runner?: ContractRunner | null): BasicNftTest
  waitForDeployment(): Promise<this>

  interface: BasicNftTestInterface
